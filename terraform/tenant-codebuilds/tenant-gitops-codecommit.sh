...
# cp -r ../silo/tenant-helm-chart/* silo/application/ || { echo "Failed to copy files"; exit 1; }
# cp -r ../silo/tenant-helm-chart   silo/infra/       || { echo "Failed to copy files"; exit 1; }
...
# cp -r ../pooled/tenant-helm-chart/* pooled/application/ || { echo "Failed to copy files"; exit 1; }
# cp -r ../pooled/tenant-helm-chart   pooled/infra/
...
# # Copy pooled base helm chart & terraform to pooled directory
# cp -r ../bridge/tenant-helm-chart/* bridge/application/ || { echo "Failed to copy files"; exit 1; }
# cp -r ../bridge/tenant-helm-chart   bridge/infra/
