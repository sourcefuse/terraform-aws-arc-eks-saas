...
module "aws_cognito_user_pool" {
  ...
  clients = [{
    ...
    # callback_urls                        = ["https://${var.domain_name}/authentication-service/auth/cognito-auth-redirect"]
    # default_redirect_url                 = "https://${var.domain_name}/authentication-service/auth/cognito-auth-redirect"
