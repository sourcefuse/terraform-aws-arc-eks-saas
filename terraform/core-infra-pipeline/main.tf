...
module "deployment_pipeline" {
  ...
  stages = [
    { name = "Bootstrap", category = "Build", owner = "AWS", provider = "CodeBuild", input_artifacts = "source_output", output_artifacts = "", run_order = "2", project_name = "${aws_codebuild_project.initial_bootstrap.name}" },
    { name = "Networking", category = "Build", owner = "AWS", provider = "CodeBuild", input_artifacts = "source_output", output_artifacts = "", run_order = "3", project_name = "${aws_codebuild_project.networking_module_build_step_codebuild_project.name}" },
    ...
    { name = "Elasticache", category = "Build", owner = "AWS", provider = "CodeBuild", input_artifacts = "source_output", output_artifacts = "", run_order = "4", project_name = "${aws_codebuild_project.elasticache_module_build_step_codebuild_project.name}" }
  ]
