...
module "deployment_pipeline" {
  ...
  stages = [
    { name = "Source", category = "Build", owner = "AWS", provider = "CodeBuild", input_artifacts = "source_output", output_artifacts = "", run_order = 1, project_name = "aws_codebuild_project.initial_bootstrap.name" },
