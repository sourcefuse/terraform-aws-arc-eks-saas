...
spec:
  ...
  source:
    path: onboarded-tenants/bridge/application/cognito
...
spec:
  destination:
    ...
    server: 'https://kubernetes.default.svc'
  source:
    path: onboarded-tenants/bridge/application/auth0
    repoURL: 'https://${data.aws_ssm_parameter.github_user.value}@github.com/${data.aws_ssm_parameter.github_repo.value}.git'
    targetRevision: main
    helm:
      valueFiles:
...
spec:
  destination:
    ...
    server: 'https://kubernetes.default.svc'
  source:
    path: onboarded-tenants/bridge/application/keycloak
    repoURL: 'https://${data.aws_ssm_parameter.github_user.value}@github.com/${data.aws_ssm_parameter.github_repo.value}.git'
    targetRevision: main
    helm:
      valueFiles:
      ...
      container:
        ...
        args:
          - |
            ...
            cp -r /home/terraform/onboarded-tenants/bridge/infra/* /home/myuser/
