...
| <a name="input_karpenter_instance_category"></a> [karpenter\_instance\_category](#input\_karpenter\_instance\_category) | karpenter instance category | `string` | n/a | yes |
...
| <a name="input_tenant_tier"></a> [tenant\_tier](#input\_tenant\_tier) | Tenant Tier Category | `string` | n/a | yes |
